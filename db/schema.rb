...
ActiveRecord::Schema.define(version: 20150923194042) do
  ...
  add_index "ratings", ["ratelable_type", "ratelable_id"], name: "index_ratings_on_ratelable_type_and_ratelable_id"
